...
import clientDataNode_pb2 as clientDataNode__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in clientDataNode_pb2_grpc.py depends on'
...
def add_ClientDataNodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'uploadFile': grpc.unary_unary_rpc_method_handler(
                    servicer.uploadFile,
                    request_deserializer=clientDataNode__pb2.uploadRequest.FromString,
                    response_serializer=clientDataNode__pb2.uploadResponse.SerializeToString,
            ),
